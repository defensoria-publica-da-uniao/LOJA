<?php
    $sql = $oServico->listarServicosSolicitacao();
    $sql2 = $oServico->selectSituacao();
?>
<!-- TÍTULO E DIRETÓRIO DE NAVEGAÇÃO -->
<h1 class="page-title">
    Solicitações de <font  class="font-green-soft" >Serviços</font> <small>Todas as solicitações dos usuários</small>
</h1>
<div class="page-bar">
    <ul class="page-breadcrumb">
        ...
        <li>
            ...
            <a href="<?php echo RAIZ . "servico/solicitacaoServicos"; ?>">Serviços </a>
        </li>
    </ul>
        ...
        <div class="portlet light ">
            <div class="portlet-title">
                <div class="caption font-dark">
                    <span class="caption-subject bold uppercase">Data da Solicitação - <font  class="bold font-green-soft" >Todos</font> | Situação - <font  class="bold font-green-soft" ><?php echo utf8_encode($_SESSION['mensagemSolicitacaoServico']);?></font></span>
                </div>
                <div class="tools"> </div>
            </div>
            <div class="portlet-body">
                ...
                <div class="clearfix">
                    ...
                    <form  class="horizontal-form" method="POST" action="<?php echo CONTROLLER .'servico.php'; ?>" enctype="multipart/form-data" onSubmit="return valida_form()">
                        <input type="hidden" name="method" value="listarServicosSolicitacao">
