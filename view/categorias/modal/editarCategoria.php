...
<div class="modal fade bs-modal-lg " id="editarCategoria" tabindex="-1" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="modal-content">
            
            <div class="modal-header" align="center">
                <button type="button" class="close" data-dismiss="modal" aria-hidden="true"></button>
                <h4 class="modal-title"><b>Editar cadastro de Categoria</b></h4>
            </div>
                                    ...
                                    <div class="form-body">
                                        <div class="row" style="margin-left: -0px !important; margin-right: -0px !important;">
                                            <div class="form-group col-md-12">
                                                <label style="text-align:left !important;" >Nome atual da Categoria:<span class="required" aria-required="true">*</span></label>
                                                <input class="form-control spinner" maxlength="100" name="arrDadosForm[str_categoria]" id="str_categoria" type="text" placeholder="Categoria" required > 
                                            </div>
                                        </div>
                                        <div class="row" style="margin-left: -0px !important; margin-right: -0px !important;">
                                            <div class="form-group col-md-12">
                                                ...
                                                <select  class="form-control spinner"name="arrDadosForm[id_complexidade]" id="str_complexidade" required="">
                                                    <option value=""></option>
