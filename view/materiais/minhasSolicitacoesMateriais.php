<?php
$sql = $oMateriais->listarMateriaisSolicitacaoCliente();
...
<h1 class="page-title">
    Minhas Solicitações de <font  class="font-blue-soft" >Materiais</font> <small>Todas as solicitações enviadas</small>
</h1>
<div class="page-bar">
    <ul class="page-breadcrumb">
        <li>
            <i class="icon-folder-alt"></i>
            <a href="<?php echo RAIZ . "materiais/minhasSolicitacoesMateriais"; ?>">Minhas Solicitações de Materias </a>
        </li>
    </ul>
